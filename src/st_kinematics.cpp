...
// Implementation based off of Single Track st_kinematics defined in CommonRoad: Vehicle Models
...
CarState STKinematics::update(
    ...
    // if velocity is low or negative, use normal Kinematic Single Track st_kinematics
