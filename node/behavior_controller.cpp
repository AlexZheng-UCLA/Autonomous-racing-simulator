// Function 
// input: all sensors and control 
// output: mux_controller vector
// behavior controller get commands from joystick and keyboard to change the mux_controller
// also it calculate the ttc to check the collision 
...
public:
    ...
    void joy_callback(const sensor_msgs::Joy & msg) {
        ...
        else if (msg.buttons[random_control_button_idx]) { 
            // random control
            toggle_mux(random_control_mux_idx, "Random control");
        ...
        else if (msg.buttons[autodrive_button_idx]) {
         // new planner
         toggle_mux(autodrive_mux_idx, "Autodrive Planner");
        }
    ...
    void key_callback(const std_msgs::String & msg) {
        ...
        } else if (msg.data == random_control_key_char) {
            // random control
            toggle_mux(random_control_mux_idx, "Random control");
        ...
        // ***Add new else if statement here for new planning method***
        else if (msg.data == autodrive_key_char) {
         // new planner
         toggle_mux(autodrive_mux_idx, "Autodrive Planner");
        }
